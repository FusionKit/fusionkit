...
class Equilibrium:
    ...
    def read_geqdsk(self,f_path=None,just_raw=False,add_derived=False):
        ...
        self.raw.update(self._read_eqdsk(f_path))
    ...
    def write_geqdsk(self,f_path=None):
        ...
        if self.raw:
            try:
                self._write_eqdsk(f_path,**self.raw)
            except TypeError:
    ...
    def _write_eqdsk(self, filepath, nw, nh, rdim, zdim, rcentr, rleft, zmid, rmaxis, zmaxis, simag, sibry, bcentr, \
